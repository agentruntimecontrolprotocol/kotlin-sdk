...
import dev.fizzpop.arcp.envelope.Priority
...
import dev.fizzpop.arcp.messages.EventEmit
import dev.fizzpop.arcp.messages.JobProgress
import dev.fizzpop.arcp.messages.Log
import dev.fizzpop.arcp.messages.LogLevel
import dev.fizzpop.arcp.messages.Ping
import dev.fizzpop.arcp.messages.SubscriptionFilter
import dev.fizzpop.arcp.store.EventLog
...
class SubscriptionManagerTest :
    StringSpec({
        ...
        fun env(
            ...
            payload: dev.fizzpop.arcp.messages.MessageType = JobProgress(percent = 1),
        ) = Envelope(
            id = MessageId(id),
            timestamp = ts,
            sessionId = sessionId,
