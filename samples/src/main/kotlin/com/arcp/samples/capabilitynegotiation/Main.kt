package com.arcp.samples.capabilitynegotiation
...
private val FALLBACK_CHAINS: Map<String, List<String>> =
    mapOf(
...
internal fun candidateChain(
    ...
    requestClass: String,
): List<String> = FALLBACK_CHAINS[requestClass].orEmpty().filter { name ->
...
internal fun consumeMetric(
    env: Envelope,
    totals: MutableMap<String, Usage>,
) {
...
private fun CoroutineScope.meter(
    c: ARCPClient,
    totals: MutableMap<String, Usage>,
): Job = launch {
